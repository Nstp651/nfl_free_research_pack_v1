...
def build_manifest(source: dict, assists: dict, rebounds: dict, prior_pack: dict, *, paths: dict[str, str]) -> dict:
    ...
    manifest = {
        "schema_version": "nba_runtime_assets_v1",
        "market_data": False,
        "asset_revision": "NBA_PLAYER_PROPS_V1.0.0",
        "history_sha256": source["history_sha256"],
        "source_acceptance_receipt_sha256": source["receipt_sha256"],
        "qbase_heads": {
            "assists": {"path": paths["assists"], "model_version": assists["model_version"], "promotion_receipt_sha256": assists["promotion_receipt_sha256"]},
            "rebounds": {"path": paths["rebounds"], "model_version": rebounds["model_version"], "promotion_receipt_sha256": rebounds["promotion_receipt_sha256"]},
        },
        "runtime_prior": {"path": paths["prior"], "pack_sha256": prior_pack["pack_sha256"], "player_count": prior_pack["player_count"], "team_count": prior_pack["team_count"]},
...
def main() -> None:
    ...
    manifest = build_manifest(source, assists, rebounds, prior, paths=paths)
