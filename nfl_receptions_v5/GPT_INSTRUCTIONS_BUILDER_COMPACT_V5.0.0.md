...
Create stable evidence IDs. Every model-moving claim records source, source date if known, checked time, finding and model pathway. Use exact locked-pack `player_id` when available; truly unlisted players use `UNLISTED_...`.
