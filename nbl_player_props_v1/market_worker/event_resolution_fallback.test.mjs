...
const frozenPlayer={player_id:'p1',player_name:'Test Guard',team:'Adelaide 36ers',heads:{assists:{confidence:'B',fragility:'LOW',qbase_anchor:{max_count:20,threshold_validation_policy:assistPolicy},probability_grid:{max_count:20,half_point_grid:[{line:4.5,over:.55,push:0,under:.45}],integer_push_grid:[]}},rebounds:{confidence:'C',fragility:'MEDIUM',qbase_anchor:{max_count:30,threshold_validation_policy:reboundPolicy},probability_grid:{max_count:30,half_point_grid:[{line:5.5,over:.4,push:0,under:.6}],integer_push_grid:[]}}}};
